...
function sim = sim_draw_init( sim )
    ...
    if sim.drawJoints
        for j=1:length(sim.joints)
          ...
          Jnt.drawn = true; 
          Jnt.P1Handle = plot(p1(1),p1(2),p1(3),'r*');
          Jnt.P1_X_AxisHandle = plot([p1(1) x1(1)],[p1(2) x1(2)],'r');
          Jnt.P1_Y_AxisHandle = plot([p1(1) y1(1)],[p1(2) y1(2)],'g');
          Jnt.P1_Z_AxisHandle = plot([p1(1) z1(1)],[p1(2) z1(2)],'b');
          %Jnt.P1_Z_pointHandle = plot(z1(1),z1(2),z1(3),'bo');

          Jnt.P2Handle = plot(p2(1),p2(2),p2(3),'r*');
          Jnt.P2_X_AxisHandle = plot([p2(1) x2(1)],[p2(2) x2(2)],'r');
          Jnt.P2_Y_AxisHandle = plot([p2(1) y2(1)],[p2(2) y2(2)],'g');
          Jnt.P2_Z_AxisHandle = plot([p2(1) z2(1)],[p2(2) z2(2)],'b');
