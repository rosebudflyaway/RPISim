...
function LCPparticleDynamics( obj )
  ...
  if (strcmp(obj.SOLVER, 'mncp_fixed_point_pgs'))
  ...
  % before the solve LCP, assign the dynamics to the obj.
  obj.dynamics = struct();
  obj.dynamics.M = M;
  obj.dynamics.Gn = Gn;
  obj.dynamics.Gf = Gf;
...
%  obj.dynamics.Quat = Quat;
  obj.dynamics.nd = fricdirs;
  obj.dynamics.h = obj.h;
  obj.dynamics.nd = fricdirs;
  ...
  switch obj.SOLVER 
      ...
      case 'mncp_fixed_point_pgs'
          % tol_rel = 0.0001;
          % tol_abs = 10*eps;
          mncp_fixed_point_pgs(obj);
      case 'fixed_point'
