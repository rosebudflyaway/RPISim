function solution  = mncp_strict_pgs2(sim)
% The difference with mncp_fixed_point_pgs is that this solver doesn't
% consider the sliding speed. Only work on the pn and pf.
...
% There is no sliding speed any more
solution.z = zeros(3*nc, max_iter);
...
for iter = 1 : max_iter  % one iteration is a loop over all the contacts
